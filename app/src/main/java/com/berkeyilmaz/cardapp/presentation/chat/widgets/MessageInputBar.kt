...
@Composable
fun MessageInputBar(
    enabled: Boolean, onSend: (String) -> Unit,
) {
    ...
    Row(
        ...
        CustomTextField(
            ...
            enabled = enabled,
            placeholder = stringResource(R.string.describe_person),
        )
        ...
        IconButton(
            ...
            Icon(
                imageVector = Icons.AutoMirrored.Filled.Send, contentDescription = "Send Button"
            )
        }
